import type { LocalPathResult, PathStep, RuneLiteSnapshot } from "./client.js";

export function tileDistance(location: any, worldX: number, worldY: number, plane?: number): number {
...
export function calculateStraightLineSteps(
  from: any,
  to: { worldX: number; worldY: number; plane?: number },
  maxStepTiles = 18,
  maxSteps = 12,
) {
...
export function withStraightLineFallback(
...
export function chooseLocalPathStep(path: LocalPathResult, maxStepTiles = 18): PathStep | undefined {
